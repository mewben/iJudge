...
<div class="control-group">
	{{ Form::label('time_limit', 'Time Limit (in minutes)', array('class'=>'control-label'))}}
	<div class="controls">
		{{ Form::text('time_limit', (isset($data->time_limit)) ? $data->time_limit : Input::old('time_limit'), array('class'=>'input-small'))}}
	</div>
</div>
<div class="control-group">
